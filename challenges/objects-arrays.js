...
const contactInfo = graduates.map(person => person.first_name + " " + person.email);
...
*/
const animalNames = zooAnimals.forEach(name => `Name: ${name.animal_name} , Scientific: ${name.scientific_name}`);
